...
var thaiponggalImg = preload("res://learning_section/Images/Celebration/Thaiponggal.png")
var pestaBoatNagaImg = preload("res://learning_section/Images/Celebration/PestaBoatNaga.png")
var eidImg = preload("res://learning_section/Images/Celebration/Eid.png")
...
func status():
	...
	if status == 2:	
		if on_move == "1":
			...
			get_node("Button" + str(n)).set_button_icon(thaiponggalImg)
			if n == 4:
			...
			get_node("Button" + str(n)).set_button_icon(pestaBoatNagaImg)
			if n == 4:
				get_node("Button4").disabled = true
			...
			get_node("Button" + str(n)).set_button_icon(eidImg)
			if n == 4:
				get_node("Button4").disabled = true
...
func _on_Button1_pressed():
	...
	if dd == false:
		...
		get_node("Sprite1").set_visible(false)
		get_node("Button1").set_button_icon(thaiponggalImg)
		dd = false
...
func _on_Button2_pressed():
	...
	if dd == false:
		...
		get_node("Sprite2").set_visible(false)
		get_node("Button2").set_button_icon(pestaBoatNagaImg)
		dd = false
...
func _on_Button3_pressed():
	...
	if dd == false:
		...
		get_node("Sprite3").set_visible(false)
		get_node("Button3").set_button_icon(eidImg)
		dd = false
...
func _on_SubmitBtn_pressed():
	...
	global.highScoreDAD = (global.highScoreDAD / 15) * 100
