...
var kainSiratImg = preload("res://learning_section/Images/TraditionalDress/KainSirat.png")
var SinuanggaImg = preload("res://learning_section/Images/TraditionalDress/Sinuangga.png")
var bajuBabanImg = preload("res://learning_section/Images/TraditionalDress/BajuBaban.png")
...
func status():
	...
	if status == 2:	
		if on_move == "1":
			...
			get_node("Button" + str(n)).set_button_icon(kainSiratImg)
			if n == 4:
			...
			get_node("Button" + str(n)).set_button_icon(SinuanggaImg)
			if n == 4:
				get_node("Button4").disabled = true
			...
			get_node("Button" + str(n)).set_button_icon(bajuBabanImg)
			if n == 4:
				get_node("Button4").disabled = true
...
func _on_Button1_pressed():
	...
	if dd == false:
		...
		get_node("Sprite1").set_visible(false)
		get_node("Button1").set_button_icon(kainSiratImg)
		dd = false
...
func _on_Button2_pressed():
	...
	if dd == false:
		...
		get_node("Sprite2").set_visible(false)
		get_node("Button2").set_button_icon(SinuanggaImg)
		dd = false
...
func _on_Button3_pressed():
	...
	if dd == false:
		...
		get_node("Sprite3").set_visible(false)
		get_node("Button3").set_button_icon(bajuBabanImg)
		dd = false
...
func _on_NextLvlBtn_pressed():
	...
	if get_node("Button5").get_text() == "2":
		global.highScoreDAD += 1
		print("Score: " + str(global.highScoreDAD))
	...
	print("Score Lvl 4: " + str(int(global.highScoreDAD)))
	
	get_tree().change_scene("res://game_section/drag_and_drop/Level5.tscn")
