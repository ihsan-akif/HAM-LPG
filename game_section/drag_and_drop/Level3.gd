...
var dotiImg = preload("res://learning_section/Images/TraditionalDress/Doti.png")
var bajuKebayaImg = preload("res://learning_section/Images/TraditionalDress/BajuKebaya.png")
var samfuImg = preload("res://learning_section/Images/TraditionalDress/Samfu.png")
...
func status():
	...
	if status == 2:	
		if on_move == "1":
			...
			get_node("Button" + str(n)).set_button_icon(dotiImg)
			if n == 4:
			...
			get_node("Button" + str(n)).set_button_icon(bajuKebayaImg)
			if n == 4:
				get_node("Button4").disabled = true
			...
			get_node("Button" + str(n)).set_button_icon(samfuImg)
			if n == 4:
				get_node("Button4").disabled = true
...
func _on_Button1_pressed():
	...
	if dd == false:
		...
		get_node("Sprite1").set_visible(false)
		get_node("Button1").set_button_icon(dotiImg)
		dd = false
...
func _on_Button2_pressed():
	...
	if dd == false:
		...
		get_node("Sprite2").set_visible(false)
		get_node("Button2").set_button_icon(bajuKebayaImg)
		dd = false
...
func _on_Button3_pressed():
	...
	if dd == false:
		...
		get_node("Sprite3").set_visible(false)
		get_node("Button3").set_button_icon(samfuImg)
		dd = false
...
func _on_NextLvlBtn_pressed():
	...
	print("Score Lvl 3: " + str(int(global.highScoreDAD)))
	
	get_tree().change_scene("res://game_section/drag_and_drop/Level4.tscn")
