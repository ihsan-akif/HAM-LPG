...
var cakarAyamImg = preload("res://learning_section/Images/TraditionalFood/CakarAyam.png")
var ulatMulongImg = preload("res://learning_section/Images/TraditionalFood/UlatMulong.png")
var pinaasakanImg = preload("res://learning_section/Images/TraditionalFood/Pinaasakan.png")
...
func status():
	...
	if status == 2:	
		if on_move == "1":
			...
			get_node("Button" + str(n)).set_button_icon(cakarAyamImg)
			if n == 4:
			...
			get_node("Button" + str(n)).set_button_icon(ulatMulongImg)
			if n == 4:
				get_node("Button4").disabled = true
			...
			get_node("Button" + str(n)).set_button_icon(pinaasakanImg)
			if n == 4:
				get_node("Button4").disabled = true
...
func _on_Button1_pressed():
	...
	if dd == false:
		...
		get_node("Sprite1").set_visible(false)
		get_node("Button1").set_button_icon(cakarAyamImg)
		dd = false
...
func _on_Button2_pressed():
	...
	if dd == false:
		...
		get_node("Sprite2").set_visible(false)
		get_node("Button2").set_button_icon(ulatMulongImg)
		dd = false
...
func _on_Button3_pressed():
	...
	if dd == false:
		...
		get_node("Sprite3").set_visible(false)
		get_node("Button3").set_button_icon(pinaasakanImg)
		dd = false
...
func _on_NextLvlBtn_pressed():
	play_sound()
	if get_node("Button4").get_text() == "3":
		global.highScoreDAD += 1
		print("Score: " + str(global.highScoreDAD))

	if get_node("Button5").get_text() == "1":
		global.highScoreDAD += 1
		print("Score: " + str(global.highScoreDAD))

	if get_node("Button6").get_text() == "2":
		global.highScoreDAD += 1
		print("Score: " + str(global.highScoreDAD))

	print("Score Lvl 2: " + str(int(global.highScoreDAD)))
	
	get_tree().change_scene("res://game_section/drag_and_drop/Level3.tscn")
