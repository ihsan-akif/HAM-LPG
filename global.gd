...
var main_scoreCW = {score_one = {name= "a", score = 00}, score_two = {name= "", score = 00}, score_three = {name= "", score = 00}, score_four = {name= "", score = 00}, score_five = {name = "", score = 00}, score_six = {name= "", score = 00}, score_seven = {name= "", score = 00}, score_eight = {name = "", score = 00}, score_nine = {name = "", score = 00}}
...
var arrayCW = [main_scoreCW.score_one, main_scoreCW.score_two, main_scoreCW.score_three, main_scoreCW.score_four, main_scoreCW.score_five, main_scoreCW.score_six, main_scoreCW.score_seven, main_scoreCW.score_eight, main_scoreCW.score_nine]
